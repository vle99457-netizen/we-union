...
export const series: Series[] = [
  ...
  },
  {
    ...
    description: 'Obsidian performance layers cut by electric-blue fracture lines and controlled contrast.',
    world: 'honor',
...
export const products: Product[] = [
  ...
  {
    slug: 'crack-travel-jacket',
    name: 'Crack Travel Jacket',
    series: 'crack',
    world: 'honor',
    price: 169,
    color: 'Obsidian / Electric Blue',
