...
const expectedPreviews = [
  ...
  ['desktop/11-stories.webp', '/stories', 'V10 Stories', 'Stories — WE', 'Stories behind the work.'],
  ...
  ['desktop/13-craftsmanship.webp', '/craftsmanship', 'V12 Craftsmanship', 'Craftsmanship — WE', 'Craft is the proof.'],
  ['desktop/14-community.webp', '/community', 'V13 Community', 'Community — WE', 'One original. Countless meanings.'],
  ['desktop/15-about.webp', '/about', 'V14 About', 'About — WE', 'Identity should never feel generic.'],
